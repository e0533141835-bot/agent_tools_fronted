...
// import { Box, Heading, Flex, Container, Text, Button, Image } from '@chakra-ui/react';
...
//       <Container maxW="650px" mt={12} position="relative">
...
//         {/* פריסה רחבה: לוגו מימין, כותרת משמאל */}
//         <Flex 
//           align="center" 
...
//               alt="Tali Match Logo" 
//               h="90px" 
//               style={{ objectFit: 'contain' }} // שימוש ב-style מבטיח תאימות מלאה
//             />
//           </Box>
...
import { useState } from 'react';
import { Box, Heading, Flex, Container, Text, Button, Image, VStack } from '@chakra-ui/react';
import Navbar from '../components/Navbar';
import MatchRoleForm from '../components/MatchRoleForm';
import ManagerSummaryForm from '../components/ManagerSummaryForm';
import logo from '../assets/logo.png';
